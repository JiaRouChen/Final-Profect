...
{
    public class CartsListController : Controller
    {
        private readonly ProjectDContext _context;

        public CartsListController(ProjectDContext context)
        {
            _context = context;
        }
        ...
        // GET: CartsList/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CartsList/Create
